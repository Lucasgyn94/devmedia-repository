...
function colecao_series() {
    ...
    var dia_semana = data_atual.getDay(); // hj e o 4 dia da semana. começando do 0 + 4, paramos na posição 3
    
    var serie_do_dia = colecao_series_programacao[dia_semana];
    
    console.log("Hoje é dia " + dia_semana )
    
    var nome_serie = serie_do_dia.nome;
    var horario_serie = serie_do_dia.horario;
    var sinopse_serie = serie_do_dia.sinopse;
    
    console.log("\nHoje é dia de " + nome_serie + " às " + horario_serie);
    console.log("\nA seguir uma visão geral da série: " + sinopse_serie);
